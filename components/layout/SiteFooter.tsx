...
export function SiteFooter({ className, kind }: SiteFooterProps) {
  ...
  return (
    ...
    //   )}
    // >
    //   <p className="inline-flex flex-wrap gap-1 justify-center items-center">
    ...
    //     <a href="https://weibo.com/u/6571509464" target="_blank" rel="noreferrer" aria-label="微博" className="transition-colors text-muted-foreground hover:text-foreground">
    //       <FaWeibo className="w-5 h-5" />
    //     </a>
    //     <a href="https://space.bilibili.com/808024" target="_blank" rel="noreferrer" aria-label="哔哩哔哩" className="transition-colors text-muted-foreground hover:text-foreground">
    ...
    //     </a>
    //     <a href="https://bangumi.tv/user/whitering" target="_blank" rel="noreferrer" aria-label="Bangumi" className="transition-colors text-muted-foreground hover:text-foreground">
    //       <svg
    ...
    //     </a>
    //   </div>
    //   <div className="flex flex-nowrap gap-2 justify-center items-center mt-3 text-xs text-muted-foreground">
    //     <a
